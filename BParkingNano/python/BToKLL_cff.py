...
BToKmumu = cms.EDProducer(
    ...
    postVtxSelection = cms.string(
        ...
        '&& userFloat("fitted_mass") > 4.5 && userFloat("fitted_mass") < 9.'
    )
)
...
BToKeeTable = cms.EDProducer(
    ...
    variables=cms.PSet(
        ...
        k_pt = ufloat('kaon_pt'), 
        k_eta = ufloat('kaon_eta'), 
        k_phi = ufloat('kaon_phi'), 
        k_mass = ufloat('kaon_mass'), 
        k_charge = uint('kaon_charge'), 
        k_pdgid = uint('kaon_pdgId'), 
        k_vx = ufloat('kaon_vx'), 
        k_vy = ufloat('kaon_vy'), 
        k_vz = ufloat('kaon_vz'), 
        k_dz = ufloat('kaon_dz'), 
        k_dxy = ufloat('kaon_dxy'), 
        k_dzS = ufloat('kaon_dzS'), 
        k_dxyS = ufloat('kaon_dxyS'), 
        k_DCASig = ufloat('kaon_DCASig'), 
        k_DCASig_corr = ufloat('kaon_DCASig_corr'), 
        k_ispacked = uint('kaon_ispacked'), 
        k_islost = uint('kaon_islost'), 
        k_chi2 = ufloat('kaon_chi2'), 
        k_normalisedChi2 = ufloat('kaon_normalisedChi2'), 
        k_validFraction = ufloat('kaon_validFraction'), 
        k_ndof = uint('kaon_ndof'), 
        k_numberOfValidHits = uint('kaon_numberOfValidHits'), 
        k_numberOfLostHits = uint('kaon_numberOfLostHits'), 
        k_numberOfValidPixelHits = uint('kaon_numberOfValidPixelHits'), 
        k_numberOfTrackerLayers = uint('kaon_numberOfTrackerLayers'), 
        k_numberOfPixelLayers = uint('kaon_numberOfPixelLayers'), 
        k_qualityIndex = uint('kaon_qualityIndex'), 
        k_highPurityFlag = uint('kaon_highPurityFlag'), 
