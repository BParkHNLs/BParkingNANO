...
public :
   ...
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_mu_mass = {fReader, "BToMuMuPi_mu0_mu_mass"};
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_mu_pt = {fReader, "BToMuMuPi_mu0_mu_pt"};
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_pi_mass = {fReader, "BToMuMuPi_mu0_pi_mass"};
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_pi_pt = {fReader, "BToMuMuPi_mu0_pi_pt"};
   ...
   TTreeReaderArray<Float_t> BToMuMuPi_dr_mu0_hnl = {fReader, "BToMuMuPi_dr_mu0_hnl"};
   TTreeReaderArray<Float_t> BToMuMuPi_dr_mu0_mu = {fReader, "BToMuMuPi_dr_mu0_mu"};
   TTreeReaderArray<Float_t> BToMuMuPi_dr_mu0_pi = {fReader, "BToMuMuPi_dr_mu0_pi"};
   ...
   //TTreeReaderArray<Float_t> BToMuMuPi_deta_mu0_hnl = {fReader, "BToMuMuPi_deta_mu0_hnl"};
   //TTreeReaderArray<Float_t> BToMuMuPi_deta_mu0_mu = {fReader, "BToMuMuPi_deta_mu0_mu"};
   //TTreeReaderArray<Float_t> BToMuMuPi_deta_mu0_pi = {fReader, "BToMuMuPi_deta_mu0_pi"};
   //TTreeReaderArray<Float_t> BToMuMuPi_dphi_mu_pi = {fReader, "BToMuMuPi_dphi_mu_pi"};
   //TTreeReaderArray<Float_t> BToMuMuPi_dphi_mu0_hnl = {fReader, "BToMuMuPi_dphi_mu0_hnl"};
   //TTreeReaderArray<Float_t> BToMuMuPi_dphi_mu0_mu = {fReader, "BToMuMuPi_dphi_mu0_mu"};
   //TTreeReaderArray<Float_t> BToMuMuPi_dphi_mu0_pi = {fReader, "BToMuMuPi_dphi_mu0_pi"};
   ...
   TTreeReaderArray<Float_t> BToMuMuPi_pi_mu0_vzdiff = {fReader, "BToMuMuPi_pi_mu0_vzdiff"};
   ...
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_eta = {fReader, "BToMuMuPi_mu0_eta"};
   ...
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_phi = {fReader, "BToMuMuPi_mu0_phi"};
   TTreeReaderArray<Float_t> BToMuMuPi_mu0_pt = {fReader, "BToMuMuPi_mu0_pt"};
   ...
   //TTreeReaderArray<Int_t> BToMuMuPi_matching_mu_motherPdgId = {fReader, "BToMuMuPi_matching_mu_motherPdgId"};
   //TTreeReaderArray<Int_t> BToMuMuPi_matching_mu0_genIdx = {fReader, "BToMuMuPi_matching_mu0_genIdx"};
   //TTreeReaderArray<Int_t> BToMuMuPi_matching_mu0_motherPdgId = {fReader, "BToMuMuPi_matching_mu0_motherPdgId"};
   ...
   TTreeReaderArray<Int_t> BToMuMuPi_mu_idx = {fReader, "BToMuMuPi_mu_idx"};
   TTreeReaderArray<Int_t> BToMuMuPi_mu0_idx = {fReader, "BToMuMuPi_mu0_idx"};
   ...
   TTreeReaderArray<Int_t> BToMuMuPi_isBu = {fReader, "PV_npvs"};
   TTreeReaderArray<Int_t> BToMuMuPi_isBd = {fReader, "PV_npvs"};
   TTreeReaderArray<Int_t> BToMuMuPi_isBs = {fReader, "PV_npvs"};
   ...
   Float_t the_sig_mu0_pt = -99.;
   Float_t the_sig_mu0_eta = -99.;
   ...
   Float_t the_sig_mu0_triggermatching_dpt = -99.;
   //Float_t the_sig_mu0_ip3d = -99.;
   //Float_t the_sig_mu0_ip3dsig = -99.;
   Float_t the_sig_mu0_pfiso03 = -99.;
   Float_t the_sig_mu0_pfiso03_rel = -99.;
   //Float_t the_sig_mu0_iso03 = -99.;
   //Float_t the_sig_mu0_iso03_close = -99.;
   //Float_t the_sig_mu0_iso03_rel_close = -99.;
   Float_t the_sig_mu0_pfiso04 = -99.;
   Float_t the_sig_mu0_pfiso04_rel = -99.;
   //Float_t the_sig_mu0_iso04 = -99.;
   //Float_t the_sig_mu0_iso04_close = -99.;
   //Float_t the_sig_mu0_iso04_rel_close = -99.;
   Int_t the_sig_mu0_looseid = -99;
   Int_t the_sig_mu0_mediumid = -99;
   Int_t the_sig_mu0_tightid = -99;
   Int_t the_sig_mu0_softid = -99;
   Int_t the_sig_mu0_pfisoid = -99;
   ...
   Int_t the_sig_mu0_isglobalortrackermuon = -99;
   Int_t the_sig_mu0_isglobalnottrackermuon = -99;
   Int_t the_sig_mu0_istrackernotglobalmuon = -99;
   //Int_t the_sig_mu0_intimemuon = -99;
   //Float_t the_sig_mu0_segmentcompatibility = -99.;
   //Float_t the_sig_mu0_calocompatibility = -99.;
   //Float_t the_sig_mu0_validhitfraction = -99.;
   //Float_t the_sig_mu0_kinkfinderchi2 = -99.;
   //Float_t the_sig_mu0_globalnormalisedchi2 = -99.;
   //Float_t the_sig_mu0_localpositionchi2 = -99.;
   //Int_t the_sig_mu0_trackerhighpurityflag = -99;
   Int_t the_sig_mu0_numberofvalidmuonhits = -99;
   Int_t the_sig_mu0_numberofvalidpixelhits = -99;
   ...
   Float_t the_sig_mu_triggermatching_dpt = -99.;
   ...
   Float_t the_sig_mu0_mu_mass = -99.;
   Float_t the_sig_mu0_mu_pt = -99.;
   Float_t the_sig_mu0_pi_mass = -99.;
   Float_t the_sig_mu0_pi_pt = -99.;
   ...
   Float_t the_sig_deltar_mu0_hnl = -99.;
   Float_t the_sig_deltar_mu0_mu = -99.;
   Float_t the_sig_deltar_mu0_pi = -99.;
   //Float_t the_sig_deltaeta_mu_pi = -99.;
   //Float_t the_sig_deltaeta_mu0_hnl = -99.;
   //Float_t the_sig_deltaeta_mu0_mu = -99.;
   //Float_t the_sig_deltaeta_mu0_pi = -99.;
   //Float_t the_sig_deltaphi_mu_pi = -99.;
   //Float_t the_sig_deltaphi_mu0_hnl = -99.;
   //Float_t the_sig_deltaphi_mu0_mu = -99.;
   //Float_t the_sig_deltaphi_mu0_pi = -99.;
   ...
   Float_t the_sig_pi_mu0_vzdiff = -99.;

   Int_t the_sig_ismatched = -99;
   Int_t the_sig_mu0_ismatched = -99;
   ...
   Float_t the_gen_mu0_mu_lxy = -99.;
   Float_t the_gen_mu0_mu_lxyz = -99.;
   ...
   Float_t the_gen_mu0_pt = -99.;
   Float_t the_gen_mu0_eta = -99.;
   Float_t the_gen_mu0_phi = -99.;
   Float_t the_gen_mu0_vx = -99.;
   Float_t the_gen_mu0_vy = -99.;
   Float_t the_gen_mu0_vz = -99.;
   ...
   TH1F* sighist_selection_efficiency_mu0pt_allevents;
   TH1F* sighist_selection_efficiency_mu0pt_eventswithmultcands;
